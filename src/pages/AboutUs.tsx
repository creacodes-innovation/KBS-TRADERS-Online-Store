      ...
      <main className="flex-grow">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl text-[#5B3A29] md:text-6xl font-serif font-bold mb-4">About Us</h1>
        ...
        <section className="py-16 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-serif font-bold text-[#5B3A29] mb-6">
              ...
              <div className="bg-[#1A4D2E]/5 p-8 rounded-2xl border border-[#1A4D2E]/10">
                 <p className="text-[#5B3A29] font-medium text-lg italic">
        ...
        <section className="py-16 bg-gray-50 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-serif font-bold text-center text-[#5B3A29] text-[#5B3A29] mb-12">What Defines Our Craft</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={index} className="bg-white p-8 rounded-xl shadow-sm border-b-4 border-[#5B3A29] hover:shadow-md transition-shadow text-center">
                  <h3 className="font-bold text-[#5B3A29] mb-3">{item.title}</h3>
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="space-y-6">
              <div className="inline-block px-4 py-1 bg-[#5B3A29] text-white text-sm tracking-widest uppercase rounded-full">Our Mission</div>
              <h3 className="text-2xl font-serif font-bold text-[#5B3A29]">Delivering Global Quality with Local Care</h3>
              <ul className="space-y-4 text-gray-700">
                <li className="flex gap-3 items-start">
                  <span className="text-[#5B3A29] font-bold">✓</span>
            ...
            {/* Vision */}
            <div className="space-y-6 ">
              <div className="inline-block px-4 py-1 bg-accent text-[#5B3A29] text-sm tracking-widest uppercase rounded-full">Our Vision</div>
              <h3 className="text-2xl font-serif font-bold text-[#5B3A29]">Redefining Premium Healthy Living</h3>
              <ul className="space-y-4 text-gray-700">
                <li className="flex gap-3 items-start">
                  <span className="text-[#5B3A29] font-bold">→</span>
        ...
        {/* --- Final Promise --- */}
        <section className="py-20 bg-gradient-to-br from-[#5A3E2B] via-[#6B4F3B] to-[#8B6A55]  text-white px-4 text-center" >
