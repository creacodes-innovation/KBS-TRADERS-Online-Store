            ...
            <table className="w-full">
              <thead className="bg-muted">
                <tr>
                  ...
                  <th className="text-left p-4 font-semibold text-foreground hidden sm:table-cell">
                    Pricing Info
                  </th>
